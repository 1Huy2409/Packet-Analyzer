...
<html lang="vi">
  ...
  <body>
      ...
      <div class="upload-section">
        ...
        >
          <input
            ...
            id="fileInput"
            name="files"
            accept=".pcap,.pcapng,.cap,.log,.txt,.csv"
            multiple
            style="display: none"
          />
          ...
          <div class="upload-area" id="uploadArea">
            <div class="upload-content">
              ...
              <div class="upload-hint">
                hoặc <strong>click để chọn</strong> • Hỗ trợ .pcap, .pcapng,
                .cap, .log, .txt, .csv (Tối đa 500MB/file)
              </div>
            </div>
          </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <c:choose>
                        ...
                        <c:otherwise>
                          <span style="color: #667177; font-size: 13px">-</span>
                        </c:otherwise>
                      </c:choose>
                    </td>
                  </tr>
    ...
    <script>
      ...
      function handleFiles(files) {
        if (files.length > 0) {
          ...
          Array.from(files).forEach((file, index) => {
            ...
            fileItem.style.marginBottom =
              index < files.length - 1 ? "12px" : "0";
          ...
          clearBtn.style.cssText =
            "padding: 8px 16px; margin-top: 12px; width: 100%;";
      ...
      // Auto-refresh để cập nhật status realtime
      ...
      function checkProcessingFiles() {
        ...
        statusBadges.forEach((badge) => {
          ...
          // Chỉ refresh nếu có file PENDING hoặc PROCESSING
      ...
      function startAutoRefresh() {
        if (checkProcessingFiles()) {
          if (autoRefreshInterval === null) {
            ...
            }, 2000); // Refresh mỗi 2 giây nếu có file đang xử lý
          }
        } else {
          // Dừng auto-refresh nếu không còn file đang xử lý
          if (autoRefreshInterval !== null) {
            clearInterval(autoRefreshInterval);
            autoRefreshInterval = null;
          }
      ...
      // Kiểm tra lại mỗi 5 giây để đảm bảo auto-refresh hoạt động đúng
      setInterval(() => {
        startAutoRefresh();
      }, 5000);
    </script>
